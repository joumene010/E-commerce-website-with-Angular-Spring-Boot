...
import { AddDeliverymanComponent } from './users/add-deliveryman/add-deliveryman.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'add_deliveryman', component: AddDeliverymanComponent, canActivate: [AdminGuard]},
